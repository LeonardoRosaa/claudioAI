...
@router.post("/completions", tags=["create", "completions"], response_model=CompletionResponse)
async def create(completion: CreateCompletion, conversation_service: ConversationService = Depends(ConversationService),):
